...
public class EnderecoController {
    ...
    public void inserir(){
        ...
        FacesContext.getCurrentInstance().addMessage(null, 
                new FacesMessage(FacesMessage.SEVERITY_INFO,"Sucesso!","A endereco foi cadastrada com sucesso!"));
    }
    
    public void alterar(Endereco c){
        this.repositorioEndereco.alterar(c);
        FacesContext.getCurrentInstance().addMessage(null, 
                new FacesMessage(FacesMessage.SEVERITY_INFO,"Sucesso!","A endereco foi alterada com sucesso!"));
    }
    ...
    public void deletar(){
        ...
        FacesContext.getCurrentInstance().addMessage(null, 
                new FacesMessage(FacesMessage.SEVERITY_INFO,"Sucesso!","A endereco foi deletada com sucesso!"));
    }
