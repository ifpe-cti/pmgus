...
public class MunicipioController {
    ...
    public void setRepositorioTipoDroga(RepositorioGenerico<Municipio, Integer> repositorioMunicipio) {
    ...
    public void inserir() {
        ...
        FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage(FacesMessage.SEVERITY_INFO, "sucesso!", "o Municipio foi cadastrado com sucesso!"));
    }

    public void alterar(Municipio c) {
        this.repositorioMunicipio.alterar(c);
        FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage(FacesMessage.SEVERITY_INFO, "sucesso!", "o Municipio foi alterado com sucesso!"));
    }

    public Municipio recuperarMunicipio(Integer codigo) {
    ...
    public void deletar() {
        ...
        FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage(FacesMessage.SEVERITY_INFO, "sucesso!", "o Municipio foi deletado com sucesso!"));
    }

    public List<Municipio> recuperarTodosMunicipio() {
